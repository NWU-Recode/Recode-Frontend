      ...
      <SidebarMenuItem>
        <CollapsibleTrigger as-child>
          <SidebarMenuButton :tooltip="item.title" :size="size">
            ...
            <span v-if="item.new" class="rounded-md bg-#adfa1d px-1.5 py-0.5 text-xs text-neutral-700 leading-none no-underline group-hover:no-underline">
              New
            </span>
            ...
            >
              <SidebarMenuSubButton as-child>
                <NuxtLink :to="subItem.link" @click="setOpenMobile(false)">
                  ...
                  <span v-if="subItem.new" class="rounded-md bg-#adfa1d px-1.5 py-0.5 text-xs text-neutral-700 leading-none no-underline group-hover:no-underline">
                    New
                  </span>
                </NuxtLink>
